export const TOAST_TEXT: Readonly<Record<string, string>> = {
  created: "已保存 ♡",
  edited: "修改成功 ♡",
  deleted: "已删除",
  approved: "已允许",
