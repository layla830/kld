-- Upgrades of the populated production database keep the original shadow clock.
-- Fresh databases stay unseeded and initialize atomically on their first E-axis read.
...
SELECT
  ...
  '2026-07-13T12:22:37.508657Z'
WHERE EXISTS (SELECT 1 FROM memories LIMIT 1)
