...
const checks = [
  ...
  ["Safety: coordinate proposals are batched and reviewer-visible", files.debug.includes("BACKFILL_MODEL_BATCH_SIZE = 5") && files.debug.includes("before, proposed") && files.debug.includes('mode: apply ? "queued_for_review" : "dry_run"')],
